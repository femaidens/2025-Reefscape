...
public class LeftToLeftLvlThreeAlgae extends SequentialCommandGroup {
  /** Creates a new CenterToBackLvlTwoAlgae. */
  public LeftToLeftLvlThreeAlgae(Drive drivetrain, Outtake outtake, Intake intake, Elevator elevator, CoralTransition coralTransition, Elevating elevating) {
