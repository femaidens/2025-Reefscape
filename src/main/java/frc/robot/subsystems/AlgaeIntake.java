...
public class AlgaeIntake extends SubsystemBase {
  ...
  public AlgaeIntake() {
    ...
    globalConfig.encoder
      .positionConversionFactor(Constants.AlgaeIntakeConstants.POS_CONVERSION_FACTOR)
      .velocityConversionFactor(Constants.AlgaeIntakeConstants.VEL_CONVERSION_FACTOR);
