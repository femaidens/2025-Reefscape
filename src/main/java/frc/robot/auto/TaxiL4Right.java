...
public class TaxiL4Right extends SequentialCommandGroup {
  /** Creates a new TaxiL4. */
  public TaxiL4Right(Elevating elevating, Outtake outtake, Vision vision, CoralTransition coralTransition, Drive drive) {
