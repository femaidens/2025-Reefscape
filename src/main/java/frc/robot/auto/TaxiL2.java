...
public class TaxiL2 extends SequentialCommandGroup {
  ...
  public TaxiL2(Elevating elevating, Outtake outtake, Vision vision, CoralTransition coralTransition) {
    ...
    addCommands(
        ...
        vision.funkierLeft().withTimeout(4),
        new RunCommand(() -> vision.driveFromVision(() -> -.07, () -> 0.0, () -> 0.0)).withTimeout(0.),
        vision.stopDriving(),
        elevating.secondLevelCmd().withTimeout(3),//until(elevating.elevator::atSetpoint),
