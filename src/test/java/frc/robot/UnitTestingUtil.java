...
public class UnitTestingUtil {
  ...
  /**
   * Sets up DS and initializes HAL with default values and asserts that it
   * doesn't fail.
   */
  ...
  /**
   * Resets CommandScheduler and closes all subsystems. Please call in
   * an @AfterEach method!
   *
  ...
  /**
   * Runs CommandScheduler and updates timer repeatedly to fast forward subsystems
   * and run commands.
   *
  ...
  /**
   * Runs CommandScheduler and updates timer to fast forward subsystems by 4
   * seconds and run
   * commands.
   */
  ...
  /**
   * Schedules a command and runs it until it ends. Be careful -- if the command
   * you give never
